...
public class ScrumTeam {
    ...
    ArrayList<Tester_ScrumTeam> testers = new ArrayList<>();
    ArrayList<Developer_ScrumTeam> developers = new ArrayList<>();
    String PO;
    String BA;
    String SM;
    ...
    public void addTester(Tester_ScrumTeam tester){
        testers.add(tester);
    }

    public void addTester(Tester_ScrumTeam[] testers){
        if(testers.length ==0){
            return;
        }
    ...
    public void addDeveloper(Developer_ScrumTeam developer){
        developers.add(developer);
    }

    public void addDeveloper(Developer_ScrumTeam[] developers){
